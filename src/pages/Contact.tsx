    ...
    <div className="min-h-screen bg-background">
      ...
      {!activeBlog ? (
                    ...
                    <div>
                      ...
                      <CardTitle 
                                className="
                                    ...
                                    hover:text-[#808080] transition-colors duration-300
                                    cursor-pointer
                                "
        ...
        <section className="py-16 bg-background">
          <div className="mx-auto px-4 md:px-8 lg:px-16 max-w-7xl space-y-8">
            <Button
              variant="outline"
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold">{activeBlog.title}</h2>
